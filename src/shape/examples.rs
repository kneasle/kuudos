...
use crate::{
    ...
    regular_polygon_inradius, Shape, Side, Symmetry, V2Ext, V2,
};

fn build_or_panic(f: impl FnOnce() -> Result<Builder, BoxAddError>) -> (Shape, Symmetry) {
    let builder = f().expect("Failed to create `Builder`");
    builder.build().expect("`Builder` failed to build")
}

pub fn nine_mens_morris() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn race_track() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn radio_waves() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn useless_wheel() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn diamonds() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn mini_4x4() -> (Shape, Symmetry) {
    build_or_panic(|| {
        let mut bdr = Builder::new(4, 4, 4);
...
pub fn space_station() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn rot_sym_classic() -> (Shape, Symmetry) {
    build_or_panic(|| {
        let mut bdr = Builder::new(3, 3, 4);
...
pub fn triangle() -> (Shape, Symmetry) {
    build_or_panic(|| {
...
pub fn star(num_points: usize) -> (Shape, Symmetry) {
    build_or_panic(|| {
